...
HolonomicAgent::HolonomicAgent()
{

}


HolonomicAgent::HolonomicAgent(bool isControllable,
...
void HolonomicAgent::applyInput(const planning2d::SystemInput& /*input*/,
                                Duration /*dt*/)
{
  SM_THROW(planning2d::NoImplementationException, "Not implemented");
}

planning2d::SystemInput HolonomicAgent::computeControlOutput(
...
planning2d::CollisionObjectPtr HolonomicAgent::getWorkspaceTimeCollisionObject() const
{
...
void HolonomicAgent::setCollisionGeometry(planning2d::CollisionGeometryConstPtr geom) {
  _geometry = geom;
...
const planning2d::DiscApproximation& HolonomicAgent::getDiscApproximation(
